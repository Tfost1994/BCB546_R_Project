...
### Warnings
- You got a warning about using `melt()` several places. Melt is part of the `reshape2` package, which has been deprecated. Typically, `pivot_longer()` is preferred to `melt()`, especially if you're using tidyverse. 
...
### General comments
- Looks good overall! You hit all the main points of the assignment. The most severe issue is the graphs not printing due to the issue with "percent". This prevents the code from completing. However, the graphs look great!
